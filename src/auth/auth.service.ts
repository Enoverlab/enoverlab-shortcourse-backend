...
export class AuthService {
    ...
    async signUp(signupdetails : signupDto, response){
        try {
            ...
            response.clearCookie("auth_token",{path : '/', httpOnly : true, signed : true, sameSite : 'none'})
            ...
            response.cookie("auth_token", token, {path : '/', expires, httpOnly : true, signed : true, sameSite : 'none'})
